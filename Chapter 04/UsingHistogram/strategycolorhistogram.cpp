...
cv::Mat StrategyColorHistogram::getHistogramImage(const cv::Mat &image)
{
...
cv::Mat StrategyColorHistogram::ProcessAlgrithmIf(const cv::Mat &image)
{
    ...
    {
        cv::Mat blueImage = getHistogramImage(splitImages[0]);
        cv::Mat greenImage = getHistogramImage(splitImages[1]);
        cv::Mat redImage = getHistogramImage(splitImages[2]);
